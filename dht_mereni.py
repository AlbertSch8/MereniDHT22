...
albert@rasberri:~ $ cat dht_mereni.py 
...
try:
    ...
    cur.execute("SELECT teplota from  mereniDHT22 order by created_at DESC limit 1")
    posledni_teplota_DB = cur.fetchall()
    #print("Nactena posledni hodnota z DB: ")
    for row in posledni_teplota_DB:
       print("nactena teplota z DB: ", row[0])
       teplota_z_DB = row[0]
    #print(posledni_teplota_DB[0])
    #print(cur)
    if teplota_z_DB != temperature_c :
            print("Pokus o zapis do DB bertiho_db a tabulky mereniDHT22")
...
#connection.execute('''INSERT INTO mereniDHT22 (teplota, vlhkost) VALUES (temperature_c, humidity)''' )
    ...
    # ...
            ...
            print("Naměřená hodnota je stejná jako poslední - nic nezapisuji.")
    # ...
